...
class Users(AbstractUser, AtomicBaseModel):
    ...
    # General info
    email = models.EmailField(verbose_name=_('Email'), max_length=100, unique=True, db_column="email", null=True)
    phone = models.CharField(verbose_name=_('Phone'), max_length=20, unique=True, db_column="phone", null=True)
    password = models.CharField(verbose_name=_('Password'), max_length=128, db_column="password",null=True)
    level = models.IntegerField(verbose_name=_('Level'), null=False, blank=False, db_column="level", choices=USER_CHOICES, default=1)
    phoneNumber = models.CharField(verbose_name=_('Phone Number'), max_length=20, db_column="phone_number", null=True)
